...
| # | 类型 | 标题 | 核心内容 |
|---|------|------|---------|
| L01 | 讲义 | 世界模型的定义与来路 | 工作接口、渲染/模拟/规划、Craik、预测编码与能力分类 |
| L02 | 讲义 | 状态估计、观测编码与潜在动力学 | 部分可观测、信念状态、VAE、GRU → MDN-RNN → RSSM、自由 rollout |
...
| 阶段 | 先阅读 | 再实践 |
| --- | --- | --- |
| 基础 | L01 | 先建立共同接口，再理解历史与能力阶梯 |
| 状态估计 | L02：观察、状态与信念 | 把部分观察和历史连接到潜在状态 |
| 表示 | L02：观测编码 | P01：训练 VAE 编码器 |
| 动力学与 rollout 可靠性 | L02：潜在动力学、训练分布与自由 rollout | P02：构建并诊断 RSSM 动力学模型 |
...
推荐学习顺序：L01、L02“观察、状态与信念”、L02“观测编码”、P01、L02“潜在动力学”、L02“训练分布与自由 rollout”、P02、L03“规划与控制”、P03、L03“骨干选择”、P04、L03 可选前沿综述、L04、P05、P06、L05。

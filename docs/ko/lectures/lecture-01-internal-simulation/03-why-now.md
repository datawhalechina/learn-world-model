...
"왜 월드모델이 필요한가"를 알았다면 다음 질문은 "어떻게 만드는가"입니다. L02는 먼저 관측, 숨은 상태, 믿음 상태를 구분합니다. 이어서 고차원 픽셀을 다루기 쉬운 표현으로 압축하는 법과 그 공간에서 미래를 예측하는 법을 다룹니다. 마지막으로 학습 중의 단일 스텝 예측과 사용 중의 자유 롤아웃을 비교합니다. 이 세 층을 연결해야 Dreamer 계획을 지탱할 핵심 골격이 만들어집니다.

...
| # | 项目 | 前置 | 产出 | 交付物 |
|---|------|------|------|--------|
| P01 | [训练 VAE 编码器](./p01_vae_encoder) | L02：观测编码 | `vae_encoder.pt` | 64×64 帧上的 CNN VAE。ELBO 损失曲线。展示解耦维度的潜在遍历 |
| P02 | [构建 RSSM 动力学模型](./p02_rssm_dynamics) | P01、L02：潜在动力学 | `rssm.pt` | GRU、MDN-RNN 与 RSSM 对比。rollout 图。1 步到 5 步预测误差曲线 |

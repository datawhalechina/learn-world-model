---
title: Part A（续二）：Genie、LoopWM、WAM 与架构选型
description: Genie 的 latent action 发现机制、LoopWM 的循环动力学与谱稳定化、WAM 联合学习第四范式、八大架构族对比总结与选型决策树。
lecture: 3
---

# Part A（续二）：Genie、LoopWM、WAM 与架构选型

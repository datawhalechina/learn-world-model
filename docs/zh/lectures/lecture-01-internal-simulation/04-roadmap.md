...
| 阶段 | 先阅读 | 再实践 | 完成后应该能解释 |
| --- | --- | --- | --- |
| 基础 | L01，然后读 L02“观测编码” | [P01：训练 VAE 编码器](../../projects/p01_vae_encoder) | 观测编码器保留和舍弃了什么信息 |
| 动力学 | L02“潜在动力学”与 Dreamer 系列 | [P02：构建 RSSM](../../projects/p02_rssm_dynamics) | 有用的潜在状态为何同时需要记忆与不确定性 |

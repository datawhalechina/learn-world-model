---
title: "Frontier Debates: Language, Vision, and the Boundaries of the World"
description: Silicon Valley is obsessed with LLMs, but world model researchers say "language is opium." What did the Bitter Lesson actually say? Will world models and LLMs converge? Where does physical-world data come from? This lecture gives no answers, only the sharpest points of contention.
lecture: 5
difficulty: debate
---

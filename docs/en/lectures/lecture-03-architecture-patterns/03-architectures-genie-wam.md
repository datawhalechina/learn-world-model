---
title: "Part A (cont. 2): Genie, LoopWM, WAM, and Architecture Selection"
description: Genie's latent action discovery mechanism, LoopWM's looped dynamics and spectral stabilization, WAM's fourth-paradigm joint learning, a comparative summary of the eight architecture families, and a decision tree for architecture selection.
lecture: 3
---

# Part A (cont. 2): Genie, LoopWM, WAM, and Architecture Selection
